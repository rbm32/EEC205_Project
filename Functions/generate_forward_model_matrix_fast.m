function [H, time, x_vec, X, Z] = generate_forward_model_matrix_fast(x_vec, z_vec, num_time_samples, pulse, c, t_max, epsilon_r, h, alpha)
    ...
    parfor m = 1:num_antennas
        ...
        for p = 1:num_pixels
            ...
            [tof, x_r] = compute_fast_tof(x_pos, h, x_b, z_b, epsilon_r, c);
